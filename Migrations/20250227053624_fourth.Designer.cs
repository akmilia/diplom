...
namespace diplom.Migrations
{
    ...
    [Migration("20250227053624_fourth")]
            ...
            modelBuilder.Entity("diplom.Models.TypesSubject", b =>
                {
                    ...
                    b.ToTable("types_subjects", (string)null);
                });
            ...
            modelBuilder.Entity("diplom.Models.TypesSubject", b =>
                {
                    b.HasOne("diplom.Models.Subject", "SubjectsIdsubjectsNavigation")
                        ...
                        .HasForeignKey("SubjectsIdsubjects")
                        .IsRequired()
                        .HasConstraintName("types_subjects_subjects_idsubjects_fkey");

                    b.HasOne("diplom.Models.Type", "Types")
                        .WithMany()
                        .HasForeignKey("TypesId")
                        .IsRequired()
                        .HasConstraintName("types_subjects_types_id_fkey");

...
namespace diplom.Migrations
{
    ...
    partial class DiplomSchoolContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("diplom.Models.TypesSubject", b =>
                {
                    ...
                    b.Property<int>("SubjectsIdsubjectsNavigationIdsubjects")
                        .HasColumnType("integer");

                    b.HasKey("TypesId", "SubjectsIdsubjects");

                    b.HasIndex("SubjectsIdsubjectsNavigationIdsubjects");

                    b.ToTable("TypesSubjects");
                });
            ...
            modelBuilder.Entity("diplom.Models.User", b =>
                {
                    ...
                    b.HasKey("Idusers", "Login", "RolesIdroles")
                        .HasName("users_pkey");
            ...
            modelBuilder.Entity("diplom.Models.TypesSubject", b =>
                {
                    b.HasOne("diplom.Models.Subject", "SubjectsIdsubjectsNavigation")
                        .WithMany()
                        .HasForeignKey("SubjectsIdsubjectsNavigationIdsubjects")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("diplom.Models.Type", "Types")
                        .WithMany()
